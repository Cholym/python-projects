...
def play(word):
    ...
    guess = input('Какая буква может быть в этом слове?').upper()
    ...
    while tries != 0:
        ...
        if guess.isalpha():
           ...
           #угадали букву
            if len(guess) == 1 and guess not in guessed_letters and guess in word:
              result = []
              for i in word:
              ...
              print("Верно! Такая буква здесь есть.")
              print("".join(result))
              ...
              guess = input('Попробуете ещё одну букву или сразу слово?').upper()

            #не угадали букву
            if len(guess) == 1 and guess not in guessed_letters and guess not in word:
              print('Неверно')
              tries -= 1
              print(display_hangman(tries))
              guessed_letters.append(guess)
              guess = input('Попробуйте ввести другую букву или вариант слова').upper() 
            
            #ввели одну букву, которую уже вводили
            if len(guess) == 1 and (guess in guessed_letters):
              print('Вы уже называли такую букву')
              guess = input('Введите другую букву').upper()
            
            #ввели неправильный вариант слова
            if len(guess) > 1 and guess != word and guess not in guessed_words:
              guessed_words.append(guess)
              print('Неверно')
              tries -= 1
              print(display_hangman(tries))
              guess = input('Попробуйте ввести другое слово или букву').upper()
            
            #ввели повторно неправильный вариант слова
            if len(guess) > 1 and guess in guessed_words:
                print('Вы уже пробовали этот вариант')
                guess = input('Попробуйте ввести другое слово или букву').upper()
        ...
        #если ввели не букву
            ...
            guess = input('Введите букву или вариант слова').upper()
               
        if tries == 0:
            print('Вы исчерпали последнюю попытку. Игра окончена.')
            print(word)
            break
